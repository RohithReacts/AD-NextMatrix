            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
              <div className="md:col-span-2 flex flex-col space-y-4">
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <a href="https://wa.me/919533811528" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-muted/50 rounded-full hover:bg-green-100 hover:text-green-600 text-muted-foreground transition-colors" aria-label="WhatsApp">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
